        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Namevarchar40 = table.Column<string>(name: "Name varchar(40)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PositionId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Namevarchar50 = table.Column<string>(name: "Name varchar(50)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Usernamevarchar50 = table.Column<string>(name: "Username varchar(50)", nullable: false),
                    Passwordnvarchar50 = table.Column<string>(name: "Password nvarchar(50)", nullable: false),
                    Emailvarchar50 = table.Column<string>(name: "Email varchar(50)", nullable: false),
                    Namevarchar50 = table.Column<string>(name: "Name varchar(50)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TeamId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Namevarchar50 = table.Column<string>(name: "Name varchar(50)", nullable: false),
                    LogoUrlvarchar150 = table.Column<string>(name: "LogoUrl varchar(150)", nullable: false),
                    Initialschar3 = table.Column<string>(name: "Initials char(3)", nullable: false),
